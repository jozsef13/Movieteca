        ...
        <div class="row mb-5">
          <div class="col-md-12">
            <div class="border p-4 rounded" role="alert">
              Do you have an account? <a href="login.jsp">Click here</a> to login.
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 mb-5 mb-md-0">
            ...
            <div class="p-3 p-lg-5 border">
              ...
              <div class="form-group row">
                <div class="col-md-6">
                  <label for="c_state_country" class="text-black">State / County <span class="text-danger">*</span></label>
              ...
              <div class="form-group">
                ...
                <div class="collapse" id="ship_different_address">
                  <div class="py-2">
                    ...
                    <div class="form-group row">
                      <div class="col-md-6">
                        <label for="c_diff_state_country" class="text-black">State / County <span class="text-danger">*</span></label>
              ...
              <div class="col-md-12">
                ...
                <div class="p-3 p-lg-5 border">
                  <table class="table site-block-order-table mb-5">
                    ...
                    <tbody>
                      <tr>
                        <td>The avengers - The final battle <strong class="mx-2">x</strong>1<br> Renting</td>
                        <td>$20.00</td>
                      </tr>
                      <tr>
                        <td>The avengers Return of the whatever <strong class="mx-2">x</strong>1<br> Buying</td>
                        <td>$49.00</td>
                      </tr>
                      <tr>
