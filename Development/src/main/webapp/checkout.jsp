				...
				<div class="row mb-5">
					<div class="col-md-12">
						<div class="border p-4 rounded" role="alert">
							Do you have an account? <a href="/login.jsp">Click here</a> to
							login.
						</div>
					</div>
				</div>
						...
						<div class="p-3 p-lg-5 border">
							<div class="form-group">
								<label for="c_country" class="text-black">Country <span
									...
									<option value="3">Republica Moldova</option>
									<option value="4">Ungaria</option>
								</select>
							</div>
							...
							<div class="form-group">
								<label for="c_create_account" class="text-black"
									data-toggle="collapse" href="#create_an_account" role="button"
									aria-expanded="false" aria-controls="create_an_account"><input
							...
							<div class="form-group">
								<label for="c_ship_different_address" class="text-black"
									...
									type="checkbox" value="1" id="c_ship_different_address">
								...
								<div class="collapse" id="ship_different_address">
									<div class="py-2">
										...
										<div class="form-group row">
											...
											<div class="col-md-6">
												<label for="c_diff_postal_zip" class="text-black">Postal
													/ Zip <span class="text-danger">*</span>
												</label> <input type="text" class="form-control"
							...
							<div class="col-md-12">
								...
								<div class="p-3 p-lg-5 border">
									<table class="table site-block-order-table mb-5">
										...
										<tbody>
											<tr>
												<td>The avengers - The final battle <strong
													class="mx-2">x</strong>1<br> Renting
												</td>
												<td>$20.00</td>
											</tr>
											<tr>
												<td>The avengers Return of the whatever <strong
													class="mx-2">x</strong>1<br> Buying
												</td>
												<td>$49.00</td>
											</tr>
											<tr>
