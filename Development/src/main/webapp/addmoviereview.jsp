			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="/movies">Movies</a> <span class="mx-2 mb-0">/</span> <a
							href="/movie/<c:out value="${movie.id }" />"><c:out
								value="${movie.name }"></c:out></a> <span class="mx-2 mb-0">/</span>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-7">
							...
							<form action="/movie/addReview/<c:out value="${movie.id }"/>"
								method="post">
									...
									<div class="form-group row">
										<div class="col-md-12">
											<label for="c_message" class="text-black">Rating <span
												...
												<small><i class="icon-info-circle"></i> Must be bewtween 1 and 10!</small>
										</div>
									</div>
									<div class="form-group row">
										<div class="col-md-12">
