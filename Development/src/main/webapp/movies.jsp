									...
									<div class="block-4 text-center border">
										...
										<div class="block-4-text p-4">
											...
											<form action="/addToCart/Movie/<c:out value="${movie.id}" />">
												<input type="radio" name="orderType" value="Rent"> <label
													for="male">Rent</label> <input type="radio"
													name="orderType" value="Buy"> <label for="female">Buy</label>
												<br> <input type="submit" name="Add to Cart"
													value="Add to Cart">
											</form>
											</p>
										</div>
