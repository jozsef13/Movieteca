...
class UserServiceTests {
	...
	@Test
	public void getUserById_whenValidId_thenUserShouldBeFound() {
		int validId = 2;

		assertEquals(globalId, userSerivce.getUserById(validId).getId());
	}

	@Test
	public void getUserById_whenUserDoesNotExists_thenThrowEntityNotFoundException() {
		int nonExistingId = 34;

		assertThrows(EntityNotFoundException.class, () -> {
			userSerivce.getUserById(nonExistingId);
		});
	}
}
